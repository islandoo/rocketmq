...
public class BrokerController {
    ...
    private              ScheduleDelayThread                       scheduleDelayThread;
    ...
    public ScheduleDelayThread getScheduleDelayThread(){
    ...
    public boolean initialize() throws CloneNotSupportedException {
        ...
        if (result) {
            this.scheduleDelayThread = new ScheduleDelayThread(messageStore);
            this.scheduleDelayThread.start();
