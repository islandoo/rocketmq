...
public class SendMessageProcessor extends AbstractSendMessageProcessor implements NettyRequestProcessor {
    ...
    private RemotingCommand handlePutMessageResult(PutMessageResult putMessageResult, RemotingCommand response,
        ...
        if (sendOK) {
            ...
            if (msg.getDelayTime() > 0) {
                msg.setMsgId(putMessageResult.getAppendMessageResult().getMsgId());
                this.brokerController.getScheduleDelayThread().put(msg);
            }
            response.setRemark(null);
    ...
    private void handleDelay(PutMessageResult putMessageResult, RemotingCommand response, RemotingCommand request, MessageExt msg) {
