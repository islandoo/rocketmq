...
public class MessageExt extends Message implements Delayed{
    ...
    public long getDelay(TimeUnit unit) {
        return unit.convert(storeTimestamp + getDelayTime() - System.currentTimeMillis(), TimeUnit.MILLISECONDS);
    }
